...
<head>
  ...
  <meta name="author" content="Antet">
                    ...
                    <div>
                      ...
                      <div class="card-footer bg-transparent border-0 p-0">
                        <a href="bookings.php" class="btn btn-primary">
                          ...
                          $booking_count = $select_bookings->rowCount();
                          ?>
                          <span class="badge text-bg-secondary rounded-circle"><?= $booking_count; ?></span>
                          View bookings
                        </a>
                      </div>
                    </div>
                    ...
                    <div>
                      ...
                      <div class="card-footer bg-transparent border-0 p-0">
                        <a href="admins.php" class="btn btn-primary">
                          <?php
                          $select_admins = $conn->prepare("SELECT * FROM `users` WHERE is_admin = ?");
                          $select_admins->execute([true]);
                          $admin_count = $select_admins->rowCount();
                          ?>
                          <span class="badge text-bg-secondary rounded-circle"><?= $admin_count; ?></span>
                          View administrators
                        </a>
                      </div>
                    </div>
                    ...
                    <div>
                      ...
                      <div class="card-footer bg-transparent border-0 p-0">
                        <a href=" messages.php" class="btn btn-primary">
                          ...
                          ?>
                          <span class="badge text-bg-secondary rounded-circle"><?= $message_count; ?></span>
                          View messages
                        </a>
                      </div>
                    </div>
              ...
              if ($select_bookings->rowCount() > 0) {
                while ($booking = $select_bookings->fetch(PDO::FETCH_ASSOC)) {
                  ...
                  <tr>
                    ...
                    <td><?= htmlspecialchars($booking['last_name']); ?>, <?= htmlspecialchars($booking['first_name']); ?>
                    </td>
                  </tr>
                  <?php
                }
