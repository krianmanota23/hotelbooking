<div class="offcanvas-md offcanvas-end bg-body-tertiary" tabindex="-1" id="sidebarMenu"
  ...
  <div class="offcanvas-body d-md-flex flex-column p-0 pt-lg-3 overflow-y-auto">
    <ul class="nav flex-column">
      ...
      <li class="nav-item">
        <a class="nav-link d-flex align-items-center gap-2" href="bookings.php">
          <svg class="bi">
      ...
      <li class="nav-item">
        <a class="nav-link d-flex align-items-center gap-2" href="admins.php">
          <svg class="bi">
    ...
    <ul class="nav flex-column mb-auto">
      ...
      <li class="nav-item">
        <a class="nav-link d-flex align-items-center gap-2" href="../components/admin_logout.php"
